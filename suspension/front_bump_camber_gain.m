...
x1 = 255; y1 = 275; % Upper pickup point A
x2 = 255; y2 = 138; % Lower pickup point B
x3 = 590; y3 = 138; % Lower balljoint point C
x4 = 580; y4 = 362; % Upper balljoint point D
t = 1250; % track width

ang_step_rad = 0.0015; % this is the step increase of alpha
...
n = 100; % number of points/iterations
